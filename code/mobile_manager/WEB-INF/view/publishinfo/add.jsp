...
<form action="${pageContext.request.contextPath}/pubilshInfoAction/add" id="addForm" role="form" class="form-horizontal" method="post">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h4 class="modal-title">新增App版本</h4>
	</div>
		...
		<div class="row" style="max-height: 600px; overflow: scroll-y;">
			...
			<div class="col-xs-12">
				<div class="form-group">
					...
					<label class="col-xs-2 control-label"><label class="text-danger" for="editionCode"></label> 版本号： </label>
					<div class="col-xs-8">
						<input type="text" id="editionCode" name="editionCode"  placeholder="请输入App版本号" type="text" class="form-control "  required="required" >
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-1 formCtrl"></div>
					...
					<div class="col-xs-8">
						<textarea rows="5" name="changeLog" id="changeLog" placeholder="请填写更新日志，以便用户了解App" class="form-control " ></textarea>
					</div>
				</div>
				<div class="form-group ">
					<div class="col-xs-1 formCtrl"></div>
					...
					<div class="col-xs-8">
						<code:select category="YESORNO" selectClass="form-control" name="isLatest" id="isLatest"/>
					</div>
				</div>
				<div class="form-group">
