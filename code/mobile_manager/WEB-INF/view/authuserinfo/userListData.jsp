...
<header class="main-box-header clearfix">
	<div class="row m-b-sm m-t-sm">
		<div class="col-xs-2">
			<a data-target="#commonWin" class="btn btn-primary btn-sm" type="button" data-toggle="modal" href="${pageContext.request.contextPath}/AuthUserInfoAction/add"><i class="fa fa-plus-circle"></i>&nbsp;新增</a>
			<a   class="btn btn-primary btn-sm" type="button"   onclick="syncUserInfo();"><i class="fa fa-plus-circle"></i>&nbsp;同步数据</a>
		</div>
					...
					<form id="submitForm" action="${pageContext.request.contextPath}/userAction/delete" method="post">
						<c:forEach var="record" items="${page.recordList}" varStatus="status">
		               		<tr>
								...
								<td>${record.loginCode}</td>
								<td class="text-center">
									<a href="${pageContext.request.contextPath}/AuthUserInfoAction/modify/${record.code}" data-target="#commonWin" data-toggle="modal" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
									<a href="${pageContext.request.contextPath}/AuthUserInfoAction/roleList/${record.code}" data-target="#commonWin" data-toggle="modal" class="btn btn-primary btn-xs"><i class="fa fa-list"></i></a>
